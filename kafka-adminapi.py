#!/usr/bin/env python
#
# Program borrowed from https://github.com/confluentinc/confluent-kafka-python/blob/master/examples/adminapi.py
# with edits to support kerberos. All license agreements from the original code still applies.
#
#
...
if __name__ == '__main__':
    ...
    #a = AdminClient( ** conf)
    a = AdminClient({'bootstrap.servers': broker,'security.protocol': 'SASL_PLAINTEXT', 'sasl.kerberos.kinit.cmd': 'echo -ne ""'})
